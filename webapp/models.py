...
class Post(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('webapp:post_detail', args=[str(self.id)])
...
class Our_WORKS_CATEGORY(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('webapp:our_work_detail', args=[str(self.id)])
...
class Our_STYLE_CATEGORY(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('webapp:style_detail', args=[str(self.id)])
...
class PRODUCT_CATEGORY(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('webapp:product_detail', args=[str(self.id)])
